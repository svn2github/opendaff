 ...
 *  --= File information =--
 *
 *  File:		DAFFPropertiesImpl.h
 *  Purpose:	Property implementation class
 ...
 *              Hendrik Vorwerk (...@akustik.rwth-aachen.de)
 *
 */

#ifndef __DAFFPROPERTIESIMPL_H__
#define __DAFFPROPERTIESIMPL_H__
...
#endif // __DAFFPROPERTIESIMPL_H__
