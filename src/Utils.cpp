...
namespace DAFF
{
	...
	float anglef_proj_0_360_DEG( float alpha ) {
		return DAFFUtils::rad2gradf( anglef_proj_0_2PI( DAFFUtils::grad2radf( alpha ) ) );
	}
	...
	float anglef_mindiff_0_360_DEG( float alpha, float beta ) {
		return DAFFUtils::rad2gradf( anglef_mindiff_0_2PI( DAFFUtils::grad2radf( alpha ), DAFFUtils::grad2radf( beta ) ) );
	}

	float anglef_mindiff_abs_0_360_DEG( float alpha, float beta ) {
		return DAFFUtils::rad2gradf( anglef_mindiff_abs_0_2PI( DAFFUtils::grad2radf( alpha ), DAFFUtils::grad2radf( beta ) ) );
	}
