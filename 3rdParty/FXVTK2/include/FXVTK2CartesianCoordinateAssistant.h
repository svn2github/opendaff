/*
   ...
   +------------------------------------------------------------------------+
   |																		|
   |  File:     FXVTK2CartesianCoordinateAssistant.h						|
   |  Purpose:  Creates lines, arrows and axes								|
   |  Authors:  Jonas Stienen (stienen@akustik.rwth-aachen.de)				|
   |			Hendrik Vorwerk (Hendrik.Vorwerk@akustik.rwth-aachen.de		|
   |																		|
   +------------------------------------------------------------------------+
*/
// $Id: $

#ifndef __FXVTK2_CARTESIAN_COORDINATE_ASSISTANT_H__
#define __FXVTK2_CARTESIAN_COORDINATE_ASSISTANT_H__

#include <FXVTK2SGNode.h>
#include <FXVTK2Arrow.h>
#include <FXVTK2Grid.h>
#include <FXVTK2Plane.h>
 ...
 *
 */
class CartesianCoordinateAssistant : public SGNode {
public:
	//! Constructor
...
#endif //  __FXVTK2_CARTESIAN_COORDINATE_ASSISTANT_H__
