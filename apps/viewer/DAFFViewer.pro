...
# Qwt
win32:CONFIG(release, debug|release): LIBS += -LC:\dev\ExternalLibs\qwt\qwt-6.1.2\win32-x64.vc12\lib -lqwt
else:win32:CONFIG(debug, debug|release): LIBS += -LC:\dev\ExternalLibs\qwt\qwt-6.1.2\win32-x64.vc12\lib -lqwtd

INCLUDEPATH += C:\dev\ExternalLibs\qwt\qwt-6.1.2\win32-x64.vc12\include
DEPENDPATH += C:\dev\ExternalLibs\qwt\qwt-6.1.2\win32-x64.vc12\lib
